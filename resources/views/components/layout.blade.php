...
<html lang="en">
    <head>
        ...
        <title>Studentski Oglasnik | Pronađi posao za sebe!</title>
    </head>
    <body class="mb-48">
        <nav class="flex justify-between items-center mb-4">
            ...
            <ul class="flex space-x-6 mr-6 text-lg">
                {{--auth omogućava da se stvari prikazuju samo ulogiranim korisnicima--}}
                @auth
                <li>
    ...
    <footer
        ...
        >
            <p class="ml-2">Copyright &copy; 2022, Sva prava pridržana</p>
